  ...
  return (
    <label
      className={cn(
        ...
        compact ? "min-w-0 min-h-0" : "min-w-[48px] min-h-[48px]"
      )}
        ...
        >
          <div
            className={cn(
              ...
              isPressed ? handleSizePressed : isChecked || (shouldRenderIcons && !isSmall) ? handleSizeChecked : handleSizeUnchecked
            )}
          >
            {shouldRenderIcons && (
